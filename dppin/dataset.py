...
class DppinDataset(InMemoryDataset):
    def __init__(self, data_dir, root, mode='train', window=10, train_num=4, valid_num=1, transform=None, pre_transform=None):
        ...
        self.name_list = ['Breitkreutz','Krogan(MALDI)', 'Gavin','Krogan(LCMS)', 'Ito', 'Ho', 'Babu', 'Hazbun','Lambert','Tarassov','Uetz','Yu']
    ...
    def process(self):
        ...
        for i, name in enumerate(name_list):
            ...
            for i in range(self.window,36):
                ...
                edge_index_sampled, link_pre_y = link_sampling(past_features, edge_list[i-1], 5)
