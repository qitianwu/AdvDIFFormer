  ...
  do
    ...
    do
      ...
      do
        for f in 1 2 3
        do
          python main.py --dataset twitch --method ours2 --lr 1e-3 --weight_decay 0. --num_layers $e --K_order $f \
--hidden_channels 64 --num_heads 1 --kernel simple --use_residual --use_block \
